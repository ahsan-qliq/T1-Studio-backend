...
export const getWhyT1Page = async (req: Request, res: Response) => {
  try {
...
export const updateWhyT1Page = async (req: Request, res: Response) => {
  try {
    const slug = req.query.slug as string;
...
export const deleteWhyT1Page = async (req: Request, res: Response) => {
  try {
    const slug = req.query.slug as string;
