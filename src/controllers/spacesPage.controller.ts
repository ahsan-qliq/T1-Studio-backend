...
import {
  createSpacesPageService,
  getSpacesPageService,
...
export const getSpacesPage = async (req: Request, res: Response) => {
  try {
    ...
    const page = await getSpacesPageService(slug, lang);
...
export const updateSpacesPage = async (req: Request, res: Response) => {
  try {
    const slug = req.query.slug as string;
...
export const deleteSpacesPage = async (req: Request, res: Response) => {
  try {
    const slug = req.query.slug as string;
