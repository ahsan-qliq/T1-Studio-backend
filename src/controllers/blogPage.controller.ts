...
import {
  createBlogPageService,
  getBlogPageService,
  updateBlogPageService,
  deleteBlogPageService,
} from "../services/blogPage.service.ts";

export const createBlogPage = async (req: Request, res: Response) => {
  try {
...
export const getBlogPage = async (req: Request, res: Response) => {
  try {
    ...
    const page = await getBlogPageService(slug, lang);
...
export const updateBlogPage = async (req: Request, res: Response) => {
  try {
    const slug = req.query.slug as string;
...
export const deleteBlogPage = async (req: Request, res: Response) => {
  try {
    const slug = req.query.slug as string;
